...
jest.dontMock('../../../common/stores/ClinicStore');
jest.dontMock('object-assign');
jest.dontMock('keymirror');

describe('ClinicStore', function() {

  var ClinicConstants = require('../../../common/constants/ClinicConstants');
  var AppDispatcher = require('../../../common/dispatcher/AppDispatcher');
  var ClinicStore = require('../../../common/stores/ClinicStore');
  var callback = AppDispatcher.register.mock.calls[0][0];

  // // NOT NEEDED? // mock actions
  // var actionKeyTyped = function(keyType, keyValue) {
  //   return {
  //     type: ClinicConstants.KEY_TYPED,
  //     keyType: keyType,
  //     keyValue: keyValue
  //   };
  // };
  ...
  //   return {
  //     type: ClinicConstants.FORMULA_TYPED,
  //     formula: formula
  //   };
  // };
  //
  ...
  it('initializes with no active aappointment and no current appoitnment list', function() {
    expect(ClinicStore.getActiveAppointment()).toEqual({});
    expect(ClinicStore.getClinicAppointments()).toEqual([]);
  });



  // it('shows numbers on screen as we type (123)', function() {
  //   expect(ClinicStore.getDisplayScreen()).toEqual('0');
  //   callback(actionKeyTyped('number', '1'));
  //   expect(ClinicStore.getDisplayScreen()).toEqual('1');
  //   callback(actionKeyTyped('number', '2'));
  //   expect(ClinicStore.getDisplayScreen()).toEqual('12');
  //   callback(actionKeyTyped('number', '3'));
  //   expect(ClinicStore.getDisplayScreen()).toEqual('123');
  //   resetTyping();
  //   expect(ClinicStore.getDisplayScreen()).toEqual('0');
  // });
  ...
  //   expect(ClinicStore.getDisplayScreen()).toEqual('1');
  //   callback(actionKeyTyped('number', '0'));
  //   expect(ClinicStore.getDisplayScreen()).toEqual('10');
  //   callback(actionKeyTyped('number', '0'));
  //   expect(ClinicStore.getDisplayScreen()).toEqual('100');
  //   callback(actionKeyTyped('number', '0'));
  //   expect(ClinicStore.getDisplayScreen()).toEqual('1000');
  //   resetTyping();
  //
  ...
  //   expect(ClinicStore.getDisplayScreen()).toEqual('0.');
  //   callback(actionKeyTyped('number', '0'));
  //   expect(ClinicStore.getDisplayScreen()).toEqual('0.0');
  //   callback(actionKeyTyped('number', '0'));
  //   expect(ClinicStore.getDisplayScreen()).toEqual('0.00');
  //   callback(actionKeyTyped('number', '0'));
  //   expect(ClinicStore.getDisplayScreen()).toEqual('0.000');
  //   callback(actionKeyTyped('number', '1'));
  //   expect(ClinicStore.getDisplayScreen()).toEqual('0.0001');
  //   resetTyping();
  // });
  ...
  //   expect(ClinicStore.getDisplayScreen()).toEqual('1.');
  //   callback(actionKeyTyped('number', '2'));
  //   expect(ClinicStore.getDisplayScreen()).toEqual('1.2');
  //   callback(actionKeyTyped('number', '3'));
  //   expect(ClinicStore.getDisplayScreen()).toEqual('1.23');
  //   callback(actionKeyTyped('number', '4'));
  //   expect(ClinicStore.getDisplayScreen()).toEqual('1.234');
  //   callback(actionKeyTyped('action', 'back'));
  //   expect(ClinicStore.getDisplayScreen()).toEqual('1.23');
  //   callback(actionKeyTyped('number', '5'));
  //   expect(ClinicStore.getDisplayScreen()).toEqual('1.235');
  //   resetTyping();
  //
  ...
  //   expect(ClinicStore.getDisplayScreen()).toEqual('-0.');
  //   callback(actionKeyTyped('number', '1'));
  //   expect(ClinicStore.getDisplayScreen()).toEqual('-0.1');
  //   callback(actionKeyTyped('number', '2'));
  //   expect(ClinicStore.getDisplayScreen()).toEqual('-0.12');
  //   callback(actionKeyTyped('number', '3'));
  //   expect(ClinicStore.getDisplayScreen()).toEqual('-0.123');
  //   callback(actionKeyTyped('action', 'back'));
  //   expect(ClinicStore.getDisplayScreen()).toEqual('-0.12');
  //   callback(actionKeyTyped('number', '4'));
  //   expect(ClinicStore.getDisplayScreen()).toEqual('-0.124');
  //   resetTyping();
  //
  //   // typing multiples .
  //   expect(ClinicStore.getDisplayScreen()).toEqual('0');
  ...
  //   expect(ClinicStore.getDisplayScreen()).toEqual('0');
  //   callback(actionKeyTyped('number', '2'));
  //   expect(ClinicStore.getDisplayScreen()).toEqual('2');
  //   callback(actionKeyTyped('number', '3'));
  //   expect(ClinicStore.getDisplayScreen()).toEqual('23');
  //   callback(actionKeyTyped('number', '4'));
  //   expect(ClinicStore.getDisplayScreen()).toEqual('234');
  //   callback(actionKeyTyped('action', 'back'));
  //   expect(ClinicStore.getDisplayScreen()).toEqual('23');
  //   callback(actionKeyTyped('action', 'back'));
  //   expect(ClinicStore.getDisplayScreen()).toEqual('2');
  //   callback(actionKeyTyped('action', 'back'));
  //   expect(ClinicStore.getDisplayScreen()).toEqual('0');
  //   expect(ClinicStore.getDisplayFormulae()).toEqual([]);
  //   resetTyping();
  //
  ...
  //   expect(ClinicStore.getDisplayScreen()).toEqual('-123');
  //   callback(actionKeyTyped('number', '4'));
  //   expect(ClinicStore.getDisplayScreen()).toEqual('-1234');
  //   callback(actionKeyTyped('action', 'back'));
  //   expect(ClinicStore.getDisplayScreen()).toEqual('-123');
  //   callback(actionKeyTyped('action', 'back'));
  //   expect(ClinicStore.getDisplayScreen()).toEqual('-12');
  ...
  //   expect(ClinicStore.getDisplayScreen()).toEqual('3');
  //   expect(ClinicStore.getDisplayFormulae()).toEqual([
  ...
  //   expect(ClinicStore.getDisplayScreen()).toEqual('0');
  //   callback(actionKeyTyped('number', '4'));
  //   expect(ClinicStore.getDisplayScreen()).toEqual('4');
  ...
  //   callback(actionKeyTyped('number', '.'));
  //   callback(actionKeyTyped('number', '2'));
  //   expect(ClinicStore.getDisplayScreen()).toEqual('0.2');
  //   callback(actionKeyTyped('action', 'equal'));
  //   expect(ClinicStore.getDisplayScreen()).toEqual('0.3');
  //   expect(ClinicStore.getDisplayFormulae()).toEqual([
  ...
  //   expect(ClinicStore.getDisplayScreen()).toEqual('1');
  //   callback(actionKeyTyped('action', 'equal'));
  //   expect(ClinicStore.getDisplayScreen()).toEqual('1.3');
  //   expect(ClinicStore.getDisplayFormulae()).toEqual([
  //     { id: undefined, literal: '0.1 + 0.2', operator: 'add' },
  ...
  //   expect(ClinicStore.getDisplayScreen()).toEqual('1');
  //   callback(actionKeyTyped('action', 'equal'));
  //   expect(ClinicStore.getDisplayScreen()).toEqual('-0.9');
  //   expect(ClinicStore.getDisplayFormulae()).toEqual([
  //     { id: undefined, literal: '0.2 - 0.1', operator: 'substract' },
  ...
  //   expect(ClinicStore.getDisplayScreen()).toEqual('0.2');
  //   callback(actionKeyTyped('action', 'equal'));
  //   expect(ClinicStore.getDisplayScreen()).toEqual('0.02');
  //   expect(ClinicStore.getDisplayFormulae()).toEqual([
  ...
  //   expect(ClinicStore.getDisplayScreen()).toEqual('2');
  //   callback(actionKeyTyped('action', 'equal'));
  //   expect(ClinicStore.getDisplayScreen()).toEqual('0.04');
  //   expect(ClinicStore.getDisplayFormulae()).toEqual([
  //     { id: undefined, literal: '0.1 x 0.2', operator: 'multiply' },
  ...
  //   expect(ClinicStore.getDisplayScreen()).toEqual('4');
  //   callback(actionKeyTyped('action', 'equal'));
  //   expect(ClinicStore.getDisplayScreen()).toEqual('0.05');
  //   expect(ClinicStore.getDisplayFormulae()).toEqual([
  ...
  //   expect(ClinicStore.getDisplayScreen()).toEqual('2');
  //   callback(actionKeyTyped('action', 'equal'));
  //   expect(ClinicStore.getDisplayScreen()).toEqual('0.025');
  //   expect(ClinicStore.getDisplayFormulae()).toEqual([
  //     { id: undefined, literal: '0.2 ÷ 4', operator: 'divide' },
  ...
  //   expect(ClinicStore.getDisplayScreen()).toEqual('4');
  //   callback(actionKeyTyped('number', '5'));
  //   expect(ClinicStore.getDisplayScreen()).toEqual('5');
  //   callback(actionKeyTyped('action', 'equal'));
  //   expect(ClinicStore.getDisplayScreen()).toEqual('9');
  //   expect(ClinicStore.getDisplayFormulae()).toEqual([
  //     { id: undefined, literal: '1 + 2', operator: 'add'},
  ...
  //   expect(ClinicStore.getDisplayScreen()).toEqual('3');
  //   callback(actionKeyTyped('action', 'equal'));
  //   expect(ClinicStore.getDisplayScreen()).toEqual('6');
  //   expect(ClinicStore.getDisplayFormulae()).toEqual([
  //     { id: undefined, literal: '1 + 2', operator: 'add'},
  ...
  //   expect(ClinicStore.getDisplayScreen()).toEqual('5');
  //   callback(actionKeyTyped('action', 'equal'));
  //   expect(ClinicStore.getDisplayScreen()).toEqual('15');
  //   expect(ClinicStore.getDisplayFormulae()).toEqual([
  //     { id: undefined, literal: '1 + 2', operator: 'add'},
  //     { id: undefined, literal: '3 + 3', operator: 'add'},
  //     { id: undefined, literal: '6 + 4', operator: 'add'},
  ...
  //   callback(actionKeyTyped('action', 'equal'));
  //   expect(ClinicStore.getDisplayScreen()).toEqual('7');
  //   expect(ClinicStore.getDisplayFormulae()).toEqual([
  //     { id: undefined, literal: '1 + 2', operator: 'add' },
  //     { id: undefined, literal: '3 + 2', operator: 'add' },
  ...
  //   expect(ClinicStore.getDisplayScreen()).toEqual('0');
  //   callback(actionKeyTyped('action', 'equal'));
  //   expect(ClinicStore.getDisplayScreen()).toEqual('Error');
  //   expect(ClinicStore.getDisplayFormulae()).toEqual([
  //     { id: undefined, literal: '1 + 2', operator: 'add' }]);
  //
  //   // good calculation
  ...
  //   callback(actionKeyTyped('action', 'equal'));
  //   expect(ClinicStore.getDisplayScreen()).toEqual('13');
  //   expect(ClinicStore.getDisplayFormulae()).toEqual([
  //     { id: undefined, literal: '1 + 2', operator: 'add'},
  //     { id: undefined, literal: '4 + 5', operator: 'add'},
  //     { id: undefined, literal: '1 + 2', operator: 'add'},
  ...
  //   callback(actionKeyTyped('number', '0'));
  //   callback(actionKeyTyped('number', '0'));
  //   expect(ClinicStore.getDisplayScreen()).toEqual('10000000000');
  //   callback(actionKeyTyped('number', '0'));
  //   expect(ClinicStore.getDisplayScreen()).toEqual('1.00000e+11');
  //   callback(actionKeyTyped('number', '0'));
  //   expect(ClinicStore.getDisplayScreen()).toEqual('1.00000e+12');
  //   callback(actionKeyTyped('action', 'back'));
  //   expect(ClinicStore.getDisplayScreen()).toEqual('1.00000e+11');
  //   callback(actionKeyTyped('action', 'back'));
  //   expect(ClinicStore.getDisplayScreen()).toEqual('10000000000');
  ...
  //   expect(ClinicStore.getDisplayScreen()).toEqual('2');
  //   callback(actionKeyTyped('action', 'equal'));
  //   expect(ClinicStore.getDisplayScreen()).toEqual('2.00000e+12');
  //   expect(ClinicStore.getDisplayFormulae()).toEqual([
  ...
  //   expect(ClinicStore.getDisplayScreen()).toEqual('7');
  //   callback(actionKeyTyped('action', 'equal'));
  //   expect(ClinicStore.getDisplayScreen()).toEqual('1.42857e+11');
  //   expect(ClinicStore.getDisplayFormulae()).toEqual([
  ...
  //   callback(actionKeyTyped('number', '7'));
  //   callback(actionKeyTyped('number', '7'));
  //   expect(ClinicStore.getDisplayScreen()).toEqual('7777777');
  //   callback(actionKeyTyped('action', 'equal'));
  //   expect(ClinicStore.getDisplayScreen()).toEqual('18367.34878');
  //   expect(ClinicStore.getDisplayFormulae()).toEqual([
